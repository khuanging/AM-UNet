...
from .util import expand_as_one_hot
...
class _AbstractDiceLoss(nn.Module):
    ...
    def __init__(self, weight=None, sigmoid_normalization=True):
        ...
        # like to normalize the logits. Since Dice (or soft Dice in this case) is usually used for binary CC_MRI,
...
class GeneralizedDiceLoss(_AbstractDiceLoss):
    ...
    def dice(self, input, target, weight):
        target = expand_as_one_hot(target.long(), num_classes=4)
